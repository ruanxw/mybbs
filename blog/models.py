...
class Category(models.Model):
    ...
    blog = models.ForeignKey(Blog, to_field="nid", on_delete=models.CASCADE) #外键关联博客，一个博客站点可以有多个分类
...
class Article(models.Model):
    ...
    desc = models.CharField(max_length=250, null=True)  # 文章描述
...
class ArticleDetail(models.Model):
    ...
    article = models.OneToOneField(Article, to_field="nid", on_delete=models.CASCADE)
...
class Comment(models.Model):
    ...
    create_time = models.DateTimeField(auto_now_add=True)
    parent_comment = models.ForeignKey("self", null=True, blank=True, on_delete=models.CASCADE) #blank=True 在django的admin中可以不填
